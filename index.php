...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql2 = "SELECT * FROM students WHERE dept_name ='$deptName'";
...
<body>
  <div class="container">
    ...
    <div class="content">
      <div class="section-title">IIT 3rd Batch Student Attendance System</div>
      <form action="index.php" method="post">
        ...
        <div class="form-buttons">
          ...
          <!-- <input type="submit" name="submitDetails" class="submit-button" value="See Report"> -->
          <!-- <button  class="submit-button">See Report</button> -->
          <button class="submit-button"><a href="/Attendance Report/index.php">See Report</a></button>
        </div>
      </form>
